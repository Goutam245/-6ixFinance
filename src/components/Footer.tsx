        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[14px] text-muted-foreground">
              ...
              <li><Link to="/about" className="hover:text-teal-bright">Our Team</Link></li>
              <li><Link to="/resources" className="hover:text-teal-bright">Resources</Link></li>
              <li><Link to="/resources" className="hover:text-teal-bright">Blog</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-[14px] text-muted-foreground">
              <li className="flex items-start gap-2"><Phone className="w-4 h-4 mt-1 text-teal" /> +1-647-699-2997</li>
              <li className="flex items-start gap-2"><Mail className="w-4 h-4 mt-1 text-teal" /> info@6ixfinance.com</li>
              <li className="flex items-start gap-2"><MapPin className="w-4 h-4 mt-1 text-teal" /> Unit 210 – 2030 Bristol Cir, Oakville, ON, L6H 6P5</li>
            </ul>
