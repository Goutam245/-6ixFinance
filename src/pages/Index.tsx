...
const processSteps = [
  { day: "Day 1", title: "Discovery Call (30 min)", body: "We review your current compliance status, filing history, and immediate priorities." },
  { day: "Days 2-3", title: "Finance Blueprint", body: "Complete assessment of your finance function — gaps, risks, and 90-day action plan." },
  { day: "Days 4-5", title: "Team Integration", body: "Your 6ixFinance CFO joins your Slack, attends board calls, and takes ownership of the compliance calendar." },
  { day: "Week 2", title: "First Deliverables", body: "SEDAR+ calendar updated, first Power BI dashboard live, month-end close process documented." },
    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-hero min-h-screen pt-32 pb-0">
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-10 grid lg:grid-cols-[55fr_45fr] gap-14 items-center">
          <div>
            <Reveal>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full label-eyebrow text-teal border border-teal/30" style={{ background: "rgba(0,194,168,0.1)" }}>
            ...
            <Reveal delay={0.25}>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  ...
                  style={{ boxShadow: "0 4px 20px rgba(0,194,168,0.35)" }}
                >
              ...
              >
                ...
                <div className="mt-5 flex items-end gap-1.5 h-20">
                  {[35, 50, 42, 60, 55, 72, 68, 85, 78, 92, 88, 100].map((h, i) => (
                    <div key={i} className="flex-1 rounded-t" style={{ height: `${h}%`, background: "linear-gradient(180deg, #00E5C8, #00897B)" }} />
                  ))}
                </div>
      ...
      <section className="bg-bg-light py-24">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <Reveal>
            ...
            <h2 className="mt-3 font-display font-bold text-[#0D1829] text-[32px] sm:text-[40px] lg:text-[44px] leading-tight max-w-3xl" style={{ letterSpacing: "-1px" }}>
              Embedded in Your Business Within 7 Days
            </h2>
          </Reveal>
                    ...
                    <svg viewBox="0 0 100 40" className="w-full h-full">
                      <defs>
                        <linearGradient id={`g${k}`} x1="0" y1="0" x2="0" y2="1">
                          <stop offset="0%" stopColor="#00E5C8" stopOpacity="0.5" />
                      ...
                      <path d={k === 0 ? "M0,30 L20,25 L40,28 L60,15 L80,18 L100,8" : "M0,25 L20,28 L40,20 L60,22 L80,12 L100,15"} fill="none" stroke="#00E5C8" strokeWidth="1.5" />
                    </svg>
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10 text-center">
          <Reveal>
            ...
            <p className="mt-8 text-white/80 text-[13px] flex items-center justify-center gap-2">
              <Lock className="w-4 h-4" /> Confidential · No obligation · Response within 4 business hours
            </p>
          </Reveal>
        </div>
      </section>
