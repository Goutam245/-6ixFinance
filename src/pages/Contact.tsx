...
const ContactPage = () => {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    toast({ title: "Request received", description: "We'll respond within 4 business hours." });
            ...
            <div className="bg-gradient-card rounded-3xl p-8 lg:p-10 border border-white/5">
              ...
              <form onSubmit={onSubmit} className="mt-8 space-y-5">
                ...
                <p className="text-center text-muted-foreground text-[13px]">
                  🔒 Confidential · Response within 4 business hours
                </p>
              </form>
            </div>
          </Reveal>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-card rounded-2xl p-7 border border-white/5 space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-white text-[15px]">Unit 210 – 2030 Bristol Cir<br />Oakville, ON, L6H 6P5</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-teal mt-1" />
                  <div>
                    <div className="text-[12px] text-muted-foreground uppercase tracking-wider">Phone</div>
                    <a href="tel:+16476992997" className="text-white text-[15px] hover:text-teal-bright">+1-647-699-2997</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-white text-[15px]">Within 4 business hours</div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-white/5 aspect-[4/3]">
                <iframe
                  ...
                  src="https://www.google.com/maps?q=2030+Bristol+Cir,+Oakville,+ON+L6H+6P5&output=embed"
