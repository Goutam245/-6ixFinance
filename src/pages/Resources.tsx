    ...
    <SiteLayout>
      ...
      <section className="bg-bg-secondary py-24">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <Reveal>
            <p className="label-eyebrow text-teal">Blog & Insights</p>
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((a, i) => (
              <Reveal key={i} delay={i * 0.06}>
                <article className="bg-gradient-card rounded-2xl overflow-hidden border border-white/5 card-hover h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="px-3 py-1 rounded-full bg-teal/15 border border-teal/30 text-teal text-[10px] font-mono uppercase tracking-wider">{a.cat}</span>
                      <span className="text-muted-foreground text-[12px]">{a.read} · {a.date}</span>
                    </div>
                    <h3 className="font-display font-semibold text-white text-[18px] leading-snug">{a.title}</h3>
                    <p className="mt-3 text-muted-foreground text-[14px] leading-[1.7] flex-1">{a.excerpt}</p>
                    <a href="#" className="mt-4 inline-flex items-center gap-1 text-teal text-[14px] font-medium hover:gap-2 transition-all">
      ...
      <section className="bg-background py-24">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-2xl p-8 border border-teal/40 h-full" style={{ background: "linear-gradient(145deg, rgba(0,194,168,0.12), rgba(0,137,123,0.06))" }}>
                <div className="flex items-center gap-3 mb-5">
