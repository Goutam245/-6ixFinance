...
const platforms = [
  { name: "QuickBooks Online", why: "Best for early-stage TSX-V issuers needing a simple, audit-friendly platform with strong third-party ecosystem." },
  { name: "Xero", why: "Excellent for multi-entity small caps. Strong bank feeds, beautiful UX, and powerful app marketplace." },
  { name: "Sage Intacct", why: "Built for true multi-entity consolidation. The right step up when you outgrow QBO/Xero." },
            ...
            {platforms.map((p, i) => (
              <Reveal key={i} delay={i * 0.08}>
                <div className="bg-white rounded-2xl p-7 border border-black/5 shadow-sm h-full hover:shadow-lg transition-shadow">
                  ...
                  <p className="mt-3 text-[#4A5568] text-[14px] leading-[1.7]">{p.why}</p>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="bg-bg-secondary py-24">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-2xl p-8 border border-teal/40" style={{ background: "linear-gradient(145deg, rgba(0,194,168,0.12), rgba(0,137,123,0.08))" }}>
